        ...
        <div class="footer-top section-padding">
            <div class="container">
                <div class="row">
                        ...
                        <div class="widget-item">
                            ...
                            <div class="widget-body">
                                <address class="contact-block">
                                    <ul>
                                        <li><i class="pe-7s-home"></i>125 Nguyên Xá, Minh Khai, Bắc Từ liêm, Hà Nội</li>
                                        <li><i class="pe-7s-mail"></i> <a href="">tuannvph50321@gmail.com </a></li>
                                        <li><i class="pe-7s-call"></i> <a href="">0345815801</a></li>
                                    </ul>
                                </address>
                            </div>
                        </div>
                    ...
                    <div class="col-lg-3 col-md-6">
                        <div class="widget-item">
                            <h6 class="widget-title">Chính sách bán hàng</h6>
