                ...
                <div class="col-lg-6">
                    <div class="checkout-billing-details-wrap">
                        ...
                        <div class="billing-form-wrap">
                                ...
                                <div class="single-input-item">
                                    <label for="dia_chi_nguoi_nhan" class="required">Địa chỉ người nhận người nhận</label>
                                    <input type="text" id="dia_chi_nguoi_nhan" name="dia_chi_nguoi_nhan" value="<?= $user['dia_chi'] ?>" placeholder="Địa chỉ người nhận người nhận" required />
                                </div>
                            ...
                            <div class="order-payment-method">
                                <div class="single-payment-method show">
                                    ...
                                    <div class="payment-method-details" data-method="cash">
                                        <p>Khác hàng có thể thanh toán sau khi đã nhận hàng thành công (cần xác nhận đơn hàng).</p>
                                    </div>
                                </div>
                                <div class="single-payment-method">
                                    ...
                                    <div class="payment-method-details" data-method="bank">
                                        <p>Khác hàng cần thanh toán online trước nếu muốn nhận hàng</p>
                                    </div>
                                </div>
