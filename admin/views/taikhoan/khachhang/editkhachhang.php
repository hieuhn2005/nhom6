                ...
                <div class="col-12">
                    <div class="card card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Sửa thông tin tài khoản khách hàng: <?= $khach_hang['ho_ten']; ?></h3>
                        </div>

                        <form action="<?= BASE_URL_ADMIN . '?act=sua-khach-hang' ?>" method="POST">
                            <input type="hidden" name="khach_hang_id" value="<?= $khach_hang['id'] ?>">
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    <label>Email</label>
                                    <input type="email" class="form-control" name="email" value="<?= $khach_hang['email'] ?>" placeholder="Nhập email">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" name="so_dien_thoai" value="<?= $khach_hang['so_dien_thoai'] ?>" placeholder="Nhập số diện thoại">
